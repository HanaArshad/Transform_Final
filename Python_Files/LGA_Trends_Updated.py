...
workbook = openpyxl.load_workbook('/Users/hanaarshadahmed/Desktop/LGA/Trends_Updated/LGA_trends.xlsx')

# Deletes specific rows in the Excel sheet
sheet = workbook['Local Government Area']
rows_to_delete = [1, 2, 3, 8126, 8127, 8128, 8129, 8130, 8131, 8132, 8133,8134,8135]
for row_index in sorted(rows_to_delete, reverse=True):
    sheet.delete_rows(row_index)
sheet.delete_cols(8, 3)

# Save the updates in Final_Trendd in the LGA folder
workbook.save('/Users/hanaarshadahmed/Desktop/LGA/Trends_Updated/Final_Trendd')

# imports pandas allows as to change values within the Excel File
import pandas as pd

# Reads the Final_trend file in the LGA Folder
location = pd.ExcelFile('/Users/hanaarshadahmed/Desktop/LGA/Trends_Updated/Final_Trendd')
...
output = '/Users/hanaarshadahmed/Desktop/LGA/Trends_Updated/Final_Trend2_.xlsx'
